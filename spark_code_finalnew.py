...
rawzone_df = sparkjob.reading_data(sparkjob.raw_source,sparkjob.raw_source_format)
...
sparkjob.write_data(df,sparkjob.raw_destination,sparkjob.raw_destination_format,sparkjob.partition_columns)
